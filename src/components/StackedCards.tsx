            ...
            <div ref={stackedCards} className='stacked-cards w-full h-[100vh] relative mx-auto md:w-[75%] flex flex-col xl:w-[clamp(85%, 4vw, 90%)] '>

              {
                ProjectItems.map((item, index) => (
                  <div key={item.id} className='absolute inset-0 lg:m-auto card w-full h-55vh  lg:h-[75vh] flex flex-col lg:flex-row-reverse rounded-md shadow-md  border border-gray-500 p-6 overflow-hidden bg-black' style={{ zIndex: index + 1 }}>
