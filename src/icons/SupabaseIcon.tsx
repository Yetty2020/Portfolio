...
const SupabaseIcon = () => (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 96 96" id="Supabase-Icon--Streamline-Svg-Logos" height="30" width="30">
  <desc>
  ...
  <path fill="url(#b)" fill-opacity=".2" d="M55.7223 93.4383c-2.4014 3.0241-7.2705 1.3672-7.3284-2.4942l-.846-56.4773h37.9752c6.8784 0 10.7146 7.9445 6.4375 13.3315l-36.2383 45.64Z"></path>
